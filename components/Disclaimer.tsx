          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                <span className="font-semibold text-gray-500">Heads up: tiger365now.com is just an informational site—we don&apos;t run a gaming service ourselves.</span>{' '}
                ...
                We aren&apos;t directly involved in the gaming itself. It&apos;s totally up to you to check if using these kinds of services is legal where you live.
                ...
                Remember, gaming can be addictive, so always play it safe and play responsibly.
              </p>
            </div>
          </div>
        </div>
