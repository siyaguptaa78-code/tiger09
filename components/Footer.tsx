          ...
          <div className="md:col-span-1">
            <Link href="/" className="inline-flex items-center mb-4">
              <span className="text-3xl font-black">
                <span className="text-red-500">Tiger</span>
            ...
            <a
              ...
              className="btn-red inline-flex items-center gap-2 text-white font-bold px-6 py-3 rounded-full text-sm uppercase tracking-wider"
            >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-gray-600 hover:text-red-500 text-sm transition-colors duration-300 flex items-center gap-2 group"
                  >
      ...
      <div className="border-t border-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-700 text-sm text-center sm:text-left">
            Copyright © 2026 <span className="text-red-500 font-medium">Tiger 365 Id</span>. All Rights Reserved.
          </p>
