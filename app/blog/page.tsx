    ...
    <main className="bg-[#0a0a0a] min-h-screen">
      ...
      <div className="w-full bg-red-950/60 border-b border-red-500/20 py-2 px-4 text-center">
        <p className="text-xs text-red-300/80">
          <span className="font-semibold">Note:</span> tigerredbook.com is an informational website only and does not offer betting services.
        </p>
      </div>
      ...
      <section className="pt-28 pb-16 bg-black relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 right-0 w-64 h-64 bg-red-500/10 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl font-black text-white mb-4">
              Tiger365 <span className="text-red-500">Blog</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {blogPosts.map((post) => (
              <article
                ...
                className="group bg-[#1a1a1a] border border-gray-800 hover:border-red-500/40 rounded-2xl overflow-hidden transition-all duration-400 hover:shadow-2xl hover:shadow-red-500/10 hover:-translate-y-2 flex flex-col"
              >
                {/* Card image area */}
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  {/* Title */}
                  <h2 className="text-lg font-bold text-white mb-3 group-hover:text-red-100 transition-colors duration-300 leading-tight">
                    {post.title}
                  </h2>
